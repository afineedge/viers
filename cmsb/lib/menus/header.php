...
<head>
  ...
  <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js"></script><?php /* for datepicker and jquery sortable */ ?>
  <script>window.jQuery.ui || document.write('<script src="<?php echo CMS_ASSETS_URL ?>/3rdParty/jquery-ui-1.11.4.min.js"><\/script>')</script>
...
<?php
  ...
  if ($usingDevSettingsFile) {
    ...
    $onclick = "alert('" .escapeJs($message). "');";
