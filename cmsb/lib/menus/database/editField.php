  ...
  <div class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-9">
        <select class="form-control" name="type" id="fieldType" onchange="displayOptionsForFieldType(0)" onkeyup="displayOptionsForFieldType(0)">
          ...
          <?php
          $fieldTypeOptions = ['none', 'textfield', 'textbox', 'wysiwyg', 'date', 'list', 'checkbox', 'upload', 'separator', 'relatedRecords', 'parentCategory'];
    ...
    <div id="fieldOptionsContainer" class="container row">
      ...
      <div style="display: none;" class="fieldOption defaultContent form-group">
        <div class="col-xs-2"><?php echo t('Default Value');?></div>
        <div class="col-xs-9">
          <textarea name="defaultContent" class="form-control" cols="60" rows="3" onfocus="this.rows=10" onblur="this.rows=3" ><?php echo htmlencode($field['defaultContent']) ?></textarea>
        </div>
      </div>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-10">
            ...
            <div class="radio">
              ...
              <?php echo t('pulldown (multi value)');?></label><br />
      ...
      <div style="display: none" class="fieldOption separatorOptions">
        ...
        <div class="col-xs-9">
          ...
          <div class="col-xs-12">
            <textarea name="separatorHTML" cols="60" rows="3" onfocus="$('#separatorType\\.html').attr('checked', true); this.rows=12" onblur="this.rows=3" class="form-control setAttr-wrap-off"><?php echo htmlencode($field['separatorHTML']) ?></textarea><br /><br />
          </div>
        </div>
      </div>
      ...
      <div style="display: none" class="fieldOption relatedRecordsOptions">
        ...
        <div class="form-group">
          ...
          <div class="col-xs-9">
            <textarea name="relatedWhere" cols="60" rows="3" class="setAttr-spellcheck-false" onfocus="this.rows=10" onblur="this.rows=3"><?php echo htmlencode($field['relatedWhere']) ?></textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-9">
            <p class="help-block">
              <?php echo sprintf('<b>Tip:</b> You can use &lt;?php ?&gt; code in both of the above fields.  Available variables:'); ?>
            </p>
    ...
    <div id="advancedOptionsContainer" class="container row">
      ...
      <div style="display: none" class="fieldOption adminOnly form-group">
        ...
        <div class="col-xs-9 form-inline">
          ...
          <label for="adminOnly"><?php echo t('Access Level - Choose if field has edit access restrictions.'); ?></label>
        </div>
      </div>
        ...
        <div class="col-xs-9">
          <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="customUploadRow" style="display: <?php echo $customUploadRowDisplay ?>">
              ...
              <td>
                <input class="form-control" type="text" name="customUploadDir" id="customUploadDir" value="<?php echo htmlencode(@$field['customUploadDir']) ?>" size="50" onkeyup="updateUploadPathPreviews('dir', this.value, 1)" onchange="updateUploadPathPreviews('dir', this.value, 1)" /><br/>
                <small>
                  <?php et('Preview:'); ?> <span id="uploadDirPreview"><?php echo htmlencode(getUploadPathPreview('dir', @$field['customUploadDir'], true, false)); ?></span><br/>
            ...
            <tr class="customUploadRow" style="display: <?php echo $customUploadRowDisplay ?>">
              ...
              <td>
                ...
                <small>
                  <?php et('Preview:'); ?> <span id="uploadUrlPreview"><?php echo htmlencode(getUploadPathPreview('url', @$field['customUploadUrl'], true, false)); ?></span><br/>
