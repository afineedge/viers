            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                    ...
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right menu-icon-select" style="-moz-column-count:4; -webkit-column-count:4; column-count:4; -webkit-column-gap: 0; -moz-column-gap: 0; column-gap: 0;">
                        ...
                        foreach ($menuPrefixIcons as $iconClass) {
                          echo "<li>
                                    <a onclick='$(\"#menuPrefixIcon\").val(\"$iconClass\")' style='cursor: pointer;'>
                                      <i aria-hidden='true' aria-label='$iconClass' class='fa $iconClass'></i>
                                    </a>
                                </li>";
                        }
                        ?>
                ...
                <div class="col-xs-12 col-sm-4 col-md-6 col-lg-3 nopadding">
                  <p class="help-block">
                    &nbsp;<a target="_blank" href="http://fontawesome.io/icons/">Find more <i aria-hidden="true" class="fa fa-external-link"></i> </a>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div role="tabpanel" class="tab-pane" id="searchTab">
          <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea name="listPageSearchFields" id="listPageSearchFields" class="form-control setAttr-spellcheck-false" rows="4" cols="50" onfocus="this.rows=10" onblur="this.rows=4"><?php echo htmlencode(@$schema['listPageSearchFields']) ?></textarea>
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-2"></div>
...
__HTML__;
        ...
        <div role="tabpanel" class="tab-pane" id="advancedTab">
          <div class="form-horizontal">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="_maxDepth"><?php echo t('Max Depth'); ?></label>
              <div class="col-sm-9">
