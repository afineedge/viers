<?php
  ...
  // upload options
  $defaultValue['allowedExtensions']     = 'gif,jpg,jpeg,png,svg,wmv,mov,swf,pdf';
...
function submitFormViaAjax() {
  ...
  'multipolygon','mutex','mysql_errno','name','names','national','natural','nchar','ndb','ndbcluster','never','new','next','no','nodegroup','nonblocking','none','not','nowait',
...
function _updateSchema($schema) {
  ...
  $fieldAttributesByType = array(    // these fields are saved for each field type
    ...
    'textfield' => array('customColumnType', 'order', 'label', 'type', 'isSystemField', 'adminOnly', 'myAccountField', 'indexed', 'defaultValue', 'fieldPrefix', 'description', 'fieldAddonBefore', 'fieldAddonAfter', 'fieldWidth', 'isPasswordField', 'isRequired', 'isUnique', 'minLength', 'maxLength', 'charsetRule', 'charset'),
