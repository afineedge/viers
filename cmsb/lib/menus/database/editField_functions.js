...
function displayOptionsForFieldType(fast) {
  ...
  else if (fieldType == 'textfield')      { showList = ".defaultValue, .fieldPrefix, .description, .fieldAddons, .fieldWidth, .isPasswordField, .requiredValue, .uniqueValue, .minMaxLength, .validationRule, .customColumnType, .indexed"; }
