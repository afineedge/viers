...
// resize when the iframe is reloaded, ie. clicking "Modify All Uploads" or when coming from the Upload form (flash uploader disabled)
     ...
     <td style="padding: 10px; vertical-align: top" valign="top">
       ...
       <table border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><?php echo htmlencode(pathinfo($uploadRecord['filePath'], PATHINFO_BASENAME)); ?></td>
        </tr>
