...
// register generator
addGenerator('cg2_rssfeed', 'RSS Feed', 'Generate an RSS Feed for vistors to subscribe to.', cg_typeByVersion(2));
...
function cg2_rssfeed_getOptions($function, $name, $description, $type) {
  ...
  $adminUI['PRE_FORM_HTML'] = ob_capture('cg2_rssfeed_ajaxJsCode'); // show ajax js code
