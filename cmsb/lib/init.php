<?php
  ...
  // check PHP Version
  define('REQUIRED_PHP_VERSION', '5.5.0'); // Supported PHP versions: http://php.net/supported-versions.php
  ...
  // define constants
  define('REQUIRED_MYSQL_VERSION', '5.0.0');                         // Released Dec 2010 - http://dev.mysql.com/doc/relnotes/mysql/5.5/en/ - this is checked in /lib/database)functions.php - connectToMySQL()
  ...
  $functions = array(); // none required currently, eg: 'filename', 'filename'
  ...
  require_once SCRIPT_DIR . '/lib/login_functions.php'; // called by errorlog_functions.php
...
function _init_fixPhpConfig() {
  ...
  ini_set('open_basedir', null);        // disable open_basedir restrictions (we also set this with php.ini for earlier php versions)
