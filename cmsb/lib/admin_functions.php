  ...
  ?>
    ...
    <?php echo @$args['FORM'] . "\n" ?>
      ...
      <div class="panel panel-default"><!-- main panel -->
        ...
        <div class="panel-body"><!-- main panel content -->
  <?php
}
...
function adminUI_checkbox($attrs) {
  _adminUI_validateAttrs($attrs, ['name', 'label', 'checked'], ['id', 'inline']);
    ...
    <div class="form-inline">
      ...
      <?php
        echo adminUI_button([
          'label'   => t('go'),
          'type'    => 'button',
          'name'    => '_advancedActionSubmitButton',
          'value'   => '1',
          'onclick' => 'unbindAndOrSubmit()',
        ]);
      ?>
      <script>
        function unbindAndOrSubmit() {
          ...
          if ($("#advancedAction").val().length > 0) {
            ...
            $("<input type='hidden' name='_advancedActionSubmit' value='1'/>").appendTo("form"); // add hidden field _advancedActionSubmit with value = 1 to trigger the advanced action
